...
export default function AgencyKpiCard({ label, value, trendText, subtitle, link, linkTo, icon: Icon, iconBg }) {
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          {subtitle && (
            <p className="mt-2.5 text-xs font-medium text-gray-500">{subtitle}</p>
          )}
          {trendText && (
