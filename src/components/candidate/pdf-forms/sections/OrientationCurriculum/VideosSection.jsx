...
const VideosSection = ({ formData, onInputChange, onBulkUpdate }) => {
  ...
  return (
    <div className="mb-8">
      <h3 className="text-lg font-semibold mb-4">Training Videos</h3>
      
      {/* Bulk Update Section */}
      <div className="mb-6 p-4 border border-blue-300 rounded-lg bg-blue-50">
        <h4 className="text-md font-semibold text-blue-800 mb-3">Bulk Update (Apply to all videos)</h4>
        ...
        <p className="text-xs text-blue-600">
          Use this section to quickly fill all videos with the same information.
        </p>
      </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                ...
                return (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <input
                        type="date"
                        value={formatDateForInput(formData[`DateRow${rowNum}_2`])}
                        onChange={(e) => onInputChange(`DateRow${rowNum}_2`, e.target.value)}
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <input
                        type="text"
                        value={formData[`Trainer InitialsRow${rowNum}_2`]}
                        onChange={(e) => handleInitialsChange(`Trainer InitialsRow${rowNum}_2`, e.target.value)}
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <input
                        type="text"
                        value={formData[`Employee InitialsRow${rowNum}_2`]}
                        onChange={(e) => handleInitialsChange(`Employee InitialsRow${rowNum}_2`, e.target.value)}
                        className="w-full px-2 py-1 border border-gray-300 rounded text-sm text-center focus:outline-none focus:ring-1 focus:ring-blue-500 uppercase"
                        placeholder="XYZ"
                        maxLength={3}
                      />
              ...
              <tr className="hover:bg-gray-50 bg-gray-50">
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <input
                    type="date"
                    value={formatDateForInput(formData[`DateRow9`])}
                    onChange={(e) => onInputChange(`DateRow9`, e.target.value)}
                    className="w-full px-2 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                </td>
                <td className="px-4 py-3 whitespace-nowrap">
                  <input
                    type="text"
                    value={formData[`Trainer InitialsRow9`]}
                    onChange={(e) => handleInitialsChange(`Trainer InitialsRow9`, e.target.value)}
                    className="w-full px-2 py-1 border border-gray-300 rounded text-sm text-center focus:outline-none focus:ring-1 focus:ring-blue-500 uppercase"
                    placeholder="ABC"
                    maxLength={3}
                  />
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <input
                    type="text"
                    value={formData[`Employee InitialsRow9`]}
                    onChange={(e) => handleInitialsChange(`Employee InitialsRow9`, e.target.value)}
                    className="w-full px-2 py-1 border border-gray-300 rounded text-sm text-center focus:outline-none focus:ring-1 focus:ring-blue-500 uppercase"
                    placeholder="XYZ"
                    maxLength={3}
                  />
      ...
      <div className="mt-6 p-4 border border-gray-300 rounded bg-gray-50">
        ...
        <ul className="text-sm text-gray-700 space-y-1 list-disc pl-5">
          <li>Fill in the date for each training video completion</li>
          <li>Enter trainer initials (maximum 3 characters)</li>
          <li>Enter your initials (maximum 3 characters)</li>
          <li>Use "Apply to All" button to quickly fill all videos with the same information</li>
          <li>The last row is for any additional training not listed above</li>
